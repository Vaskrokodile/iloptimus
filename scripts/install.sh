...
if [ "$(uname -s)" = "MINGW"* ] || [ "$(uname -s)" = "MSYS"* ] || [ "$(uname -s)" = "CYGWIN"* ]; then
  ...
  echo "  https://raw.githubusercontent.com/Vaskrokodile/optimus-studio/main/scripts/install.ps1"
  exit 0
fi
...
echo "Installing Optimus Studio…"
uv tool install --force "git+https://github.com/Vaskrokodile/optimus-studio.git"

echo
echo "Optimus Studio is installed."
